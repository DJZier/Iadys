...
#include "iadys/msg/detail/position__rosidl_typesupport_fastrtps_c.h"
...
#include "iadys/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Position__ros_msg_type = iadys__msg__Position;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_iadys
size_t get_serialized_size_iadys__msg__Position(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name teta
  {
    size_t item_size = sizeof(ros_message->teta);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Position__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_iadys__msg__Position(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_iadys
size_t max_serialized_size_iadys__msg__Position(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_iadys__msg__Position(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, iadys, msg, Position)() {
