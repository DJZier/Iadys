...
{
  new (message_memory) iadys::msg::Position(_init);
}

void Position_fini_function(void * message_memory)
{
  auto typed_message = static_cast<iadys::msg::Position *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Position_message_member_array[4] = {
  {
    ...
    offsetof(iadys::msg::Position, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(iadys::msg::Position, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(iadys::msg::Position, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(iadys::msg::Position, teta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Position_message_members = {
  "iadys::msg",  // message namespace
  "Position",  // message name
  4,  // number of fields
  sizeof(iadys::msg::Position),
...
get_message_type_support_handle<iadys::msg::Position>()
{
  return &::iadys::msg::rosidl_typesupport_introspection_cpp::Position_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, iadys, msg, Position)() {
  return &::iadys::msg::rosidl_typesupport_introspection_cpp::Position_message_type_support_handle;
}
