...
#include "iadys/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const iadys::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<iadys::msg::Position *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_iadys
const rosidl_message_type_support_t *
get_message_type_support_handle<iadys::msg::Position>()
{
  return &iadys::msg::typesupport_fastrtps_cpp::_Position__handle;
}
