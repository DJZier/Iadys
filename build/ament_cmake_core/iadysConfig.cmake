...
if(_iadys_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED iadys_FOUND)
    # explicitly set it to FALSE, otherwise CMake will set it to TRUE
    set(iadys_FOUND FALSE)
  elseif(NOT iadys_FOUND)
    # use separate condition to avoid uninitialized variable warning
    set(iadys_FOUND FALSE)
  endif()
  return()
endif()
set(_iadys_CONFIG_INCLUDED TRUE)

# output package information
if(NOT iadys_FIND_QUIETLY)
  message(STATUS "Found iadys: 0.0.0 (${iadys_DIR})")
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "Package 'iadys' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT ${iadys_DEPRECATED_QUIET})
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(iadys_FOUND_AMENT_PACKAGE TRUE)
